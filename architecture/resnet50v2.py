...
pretrained_model= resnet_v2.ResNet50V2(include_top=False,
...
plt.savefig("resnet50V2_"+ str(now.strftime("%d-%m-%Y_%H:%M:%S")) + ".jpg")
plt.show()
resnet50_model.save('resnet50V2_1.0')
...
model = ResNet50(weights = None, input_shape = (224, 224, 3), pooling = "max", classes = 2)
